...
class Expenses extends MY_Controller {
	...
	public function index($date = NULL){
		...
		$this->_data['expenses'] = $this->expenses->date_like($date)->get_all();

		$this->_data['form_btn_submit_text'] = 'Agregar Nuevo Gasto';

		$this->_data['modal_content'] = '';
		$this->_data['modal_title'] = 	'Agregar Gasto';
		$this->_data['modal_id'] = 		'expenses_modal';

		$this->_data['scripts'][] =		base_url('assets/js/expenses.js'); 	

		$this->load->view('template/header'		, $this->_data);
		$this->load->view('expenses/main'		, $this->_data);
